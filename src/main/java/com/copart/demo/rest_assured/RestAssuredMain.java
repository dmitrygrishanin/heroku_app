package com.copart.demo.rest_assured;
...
public class RestAssuredMain {
    public MainResponse getResult(String model){
        ...
        headers.put("Referer","https://www.copart.com/lotSearchResults/?free=true&query="+model);
